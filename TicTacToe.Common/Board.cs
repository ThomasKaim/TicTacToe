...
namespace TicTacToe.Common
{
    public class Board
    {
        ...
        public Board()
        {
            this._squares = new char[3][];
            this._squares[0] = new char[3] { ' ', ' ', ' ' };
            this._squares[1] = new char[3] { ' ', ' ', ' ' };
            this._squares[2] = new char[3] { ' ', ' ', ' ' };
        }

        public bool IsOAt(int row, int column)
        {
            return (this._squares[row][column] == 'O');
        }

        public bool IsXAt(int row, int column)
        {
            return (this._squares[row][column] == 'X');
        }
